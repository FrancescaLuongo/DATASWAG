...
bY2 = regress(trainY, XOrder2);


immseTrainX2 = immse(trainX, XOrder2*bX2);
immseTrainY2 = immse(trainY, XOrder2*bY2);

immseTestX2 = immse(testX, testDataXOrder2*bX2);
immseTestY2 = immse(testY, testDataXOrder2*bY2); 

%Order 3 Regressor (polynomial)
XOrder3 = [ I FM FM.^2 FM.^3];
testDataXOrder3 = [ testI testFM testFM.^2 testFM.^3];

bX3 = regress(trainX, XOrder3);
bY3 = regress(trainY, XOrder3);


immseTrainX3 = immse(trainX, XOrder3*bX3);
immseTrainY3 = immse(trainY, XOrder3*bY3);

immseTestX3 = immse(testX, testDataXOrder3*bX3);
immseTestY3 = immse(testY, testDataXOrder3*bY3); 
